...
# fig3 = px.bar(constructor_nationality_counts.head(10), x='nationality', y='count',
#               title='Top 10 Nacionalidades de Constructores',
#               labels={'count': 'Número de Constructores', 'nationality': 'Nacionalidad'},
#               text='count')  # Añadimos el número encima de cada barra

# fig3.update_traces(textposition='outside')  # Posicionamos el texto encima de las barras
...
# # Crear el boxplot
# fig4 = px.box(champion_positions, x='year', y='positionOrder',
#               title='Distribución de las Posiciones del Campeón por Año',
#               labels={'year': 'Año', 'positionOrder': 'Posición en Carrera'})
